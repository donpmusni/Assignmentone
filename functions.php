...
function assignment1_setup() {
	 ...
	 */
	load_theme_textdomain( 'assignment1', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'assignment1' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'assignment1_custom_background_args', array(
...
function assignment1_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'assignment1' ),
...
function assignment1_scripts() {
	...
	wp_enqueue_script( 'assignment1-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'assignment1-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
